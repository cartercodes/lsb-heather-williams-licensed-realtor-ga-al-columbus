  ...
  return (
    <>
      ...
      <section className="trust-bar" aria-label="Why clients trust us">
        {[
          { text: 'Licensed Realtor in Both Georgia and Alabama', icon: trustIcons[0] },
          ...
          {[
            {
              ...
              desc: 'From Midtown bungalows to Green Island Hills estates, Heather guides you through every step of purchasing your next home in the Chattahoochee Valley with expert local knowledge.',
            },
            {
              title: 'Listing & Selling',
              desc: 'Strategic pricing, professional staging advice, and aggressive marketing get your Columbus property sold faster and for top dollar. Heather\'s listings consistently outperform market averages.',
            },
            {
              title: 'Dual-State Expertise: GA & AL',
              desc: 'Licensed in both Georgia and Alabama, Heather serves clients across the Columbus-Phenix City metro seamlessly. One agent, two states, zero hassle.',
            },
            {
              title: 'Military Relocation',
              desc: 'Fort Moore families trust Heather to navigate PCS moves with speed and precision. She knows the neighborhoods, the school districts, and the timelines military life demands.',
            },
            {
              title: 'First-Time Buyer Programs',
              desc: 'Heather connects Columbus first-time buyers with down payment assistance, favorable loan programs, and patient guidance that turns renters into homeowners.',
            },
            {
              title: 'Investment Properties',
              desc: 'Columbus\'s growing rental market and proximity to Fort Moore create real opportunity. Heather identifies high-yield investment properties and helps you build lasting wealth.',
            },
          ].map((service, i) => (
            <div
      ...
      <section className="section about" aria-label="About us">
        <div className="about-grid">
          ...
          <div className="about-content" data-animate data-delay="2">
            ...
            <p className="about-text">{'Heather Williams is a licensed Realtor serving Columbus, GA and the greater Chattahoochee Valley across both the Georgia and Alabama state lines. With an intimate understanding of everything from the historic charm of Wynnton to the new developments shaping North Columbus, she brings a rare combination of market expertise and genuine care to every transaction. Whether you are a first-time buyer, a relocating military family, or a seasoned investor, Heather makes the process feel personal because to her it always is.'}</p>
